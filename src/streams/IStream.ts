...
export interface IStream<DataType, EndDataType> extends api.IStream<DataType, EndDataType> {
    ...
    map<NewDataType>(onData: (data: DataType) => DataOrPromise<NewDataType>): IStream<NewDataType, EndDataType>
    mapRaw<NewDataType>(onData: (data: DataType) => NewDataType): IStream<NewDataType, EndDataType>
    filter<NewDataType>(onData: (data: DataType) => DataOrPromise<FilterResult<NewDataType>>): IStream<NewDataType, EndDataType>
